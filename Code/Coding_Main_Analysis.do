...
* Base model
eststo m2: probit stock theta_w Estonia_D Taiwan_D China_D Vietnam_D Japan_D age gender student homemaker unemployed other_prof high_school uni_degree econ maths Buddhism Christianity Confucianism Islam Taoism Marxism married parent financial_lit CRT trust if base_pack_quality == 2, robust

eststo m3: probit stock ambig Estonia_D Taiwan_D China_D Vietnam_D Japan_D age gender student homemaker unemployed other_prof high_school uni_degree econ maths Buddhism Christianity Confucianism Islam Taoism Marxism married parent financial_lit CRT trust if base_pack_quality == 2, robust

* Aggregated model
eststo m4: probit stock theta_w ambig rrp_gain_w rrp_loss_w Estonia_D Taiwan_D China_D Vietnam_D Japan_D age gender student homemaker unemployed other_prof high_school uni_degree econ maths Buddhism Christianity Confucianism Islam Taoism Marxism married parent financial_lit CRT trust if base_pack_quality == 2, robust
...
*-------------------------------------------------------------------------------*
* Drop out high_school because of multicollinearity issues
* Subsection 
...
* Use only original answer of attitudes of risks in losses and gains and all control variables
